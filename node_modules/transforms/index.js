...
exports.transformJSX = function(source) {
  ...
  return require("react-tools")
    .transform(jsxComment + source)
    .replace(jsxComment, "");
};

var NotEqualNegativeOneVisitor = recast.Visitor.extend({
...
exports.transformNotEqualNegativeOnes = function(source) {
  var ast = recast.parse(source, recastOptions);
  ast = new NotEqualNegativeOneVisitor().visit(ast);
  return recast.print(ast).code;
};
